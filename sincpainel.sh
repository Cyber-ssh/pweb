...
wget https://github.com/Cyber-ssh/pweb/main/sshplus.zip.001 > /dev/null 2>&1
wget https://github.com/Cyber-ssh/pweb/main/sshplus.zip.002 > /dev/null 2>&1
wget https://github.com/Cyber-ssh/pweb/main/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://github.com/Cyber-ssh/pweb/main/sincpainel.zip > /dev/null 2>&1
